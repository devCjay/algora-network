...
import { removeOrder } from "../../Api/paymentApi"; // Import the removeOrder function
    ...
    useEffect(() => {
        const fetchOrder = async () => {
            try {
                ...
                const order = await AsyncStorage.getItem("newOrder");
        ...
        if (myOrder) {
            ...
            if (myOrder.payment_status === "Completed") {
                ...
                timeoutIdRef.current = setTimeout(async () => {
                    ...
                    try {
                        await removeOrder(); // Remove order from AsyncStorage
