...
const Deposit = () => {
    ...
    const handleSubmit = async () => {
      ...
      if (result.success) {
                 ...
                 navigation.replace("Payment"); // Navigate to home after login

                } else {
                  Toast.show({
                    type: "error",
                    text1: "Order Creation Failed:",
                    text2: result.message || "Try again later",
                  });
                }
        ...
        >
                    ...
                    <Modal
                        ...
                        >
                            ...
                            >
                               ...
                               {/* Separate row under TouchableOpacity, NOT affected by flex */}
                               ...
                               <View style={{
                                   ...
                                   <Text style={{...FONTS.fontSm, color: colors.title}}> {(data.amount_per_minute * 60 * 24 * 30).toFixed(2)} AGX - {(data.amount_per_minute * 60 * 24 * 30 * 0.0075).toFixed(2)} USD Monthly</Text>
                               </View>
                           </>
           ...
           {/*  Payment Modal */}
                ...
                <Modal
                    ...
                    <Header transparent leftIcon="back" title="Create Miner"/>
